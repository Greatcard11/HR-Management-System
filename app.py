...
with col1:
    ...
    <div class="card">
        ...
        <p>
            Tracks business department productivity, targets, efficiency and overall performance.
        </p>
    </div>
    """, unsafe_allow_html=True)

    st.link_button(
        "Open Business Department Appraisal",
        links["Business Department Appraisal"]
    )
